...
export const ValuesSection = () => {
  return (
    <Section
      className="flex flex-col lg:flex-row gap-4 justify-center items-center min-h-[60vh] bg-cream py-14  px-2"
    ...
    >
      ...
      <article className="flex flex-1 flex-col gap-8 justify-center items-center p-8">
