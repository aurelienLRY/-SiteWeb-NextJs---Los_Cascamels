  ...
  return (
    <React.Fragment>
      ...
      <div className="flex flex-col md:flex-row  justify-center gap-8">
        <div className="px-8 lg:px-16 py-24 min-h-[60vh] flex flex-col justify-center items-center gap-8  w-full max-w-7xl mx-auto ">
          ...
          <div className="flex  gap-8 py-8">
            <div className="flex gap-4 font-bold">
              <h3 className="text-2xl -rotate-90 flex items-end font-light text-primary">
                Contact
              </h3>
          ...
          <iframe
            ...
            allowFullScreen
            loading="lazy"
            className="w-full h-full max-h-[600px] rounded-3xl border-t-2 border-primary opacity-80 hover:opacity-100 transition-opacity duration-300"
          />
        </div>
        <ContactSection />
      </div>
